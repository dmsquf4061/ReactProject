      ...
      {open && project && (
        ...
        >
          ...
          >
            ...
            >
              <div
                className={`w-full h-full scroll-hidden flex justify-center ${
                  isExpanding ? "overflow-y-hidden" : "overflow-y-auto"
                }`}
                ref={contentRef}
                onWheel={handleContentWheel}
              >
                <div className="h-full w-full md:max-w-[1328px] flex flex-col px-4 md:px-6 gap-10">
